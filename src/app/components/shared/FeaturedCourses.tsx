...
interface Course {
  ...
  image: string;
  description?: string;
  videos?: any[]; // ভিডিও কাউন্ট করার জন্য যোগ করা হয়েছে
}
          ...
          {loading ? (
            ...
            courses.map((course, idx) => (
              ...
              >
                ...
                <div className="p-8">
                  <div className="flex items-center gap-4 text-slate-400 text-xs font-bold uppercase tracking-widest mb-4">
                    {/* ডাইনামিক ভিডিও লেন্থ এখানে দেখানো হচ্ছে */}
                    <span className="flex items-center gap-1">
                      <BookOpen size={14} /> {course.videos?.length || 0} Lessons
                    </span>
                    <span className="flex items-center gap-1">
                      <Clock size={14} /> Full Access
                    </span>
                  </div>
